...
func (inst *RepositoryLocateServiceImpl) makeResult(ctx context.Context, dir fs.Path) (*dto.Repository, error) {
	name := dir.Name()
	if name == ".git" {
		parent := dir.Parent()
		if parent != nil {
...
// Locate ...
func (inst *RepositoryLocateServiceImpl) Locate(ctx context.Context, path fs.Path) (*dto.Repository, error) {
