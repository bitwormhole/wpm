...
func autoGenConfig(cb application.ConfigBuilder) error {
	...
	// component: com3-implservice0x5a8f41.LinuxPlatformServiceImpl
	cominfobuilder.Next()
	cominfobuilder.ID("com3-implservice0x5a8f41.LinuxPlatformServiceImpl").Class("PlatformProviderRegistry").Aliases("").Scope("")
	...
	// component: com32-support0xf47d7f.WpmDataSource
	cominfobuilder.Next()
	cominfobuilder.ID("com32-support0xf47d7f.WpmDataSource").Class("starter-gorm-source-registry").Aliases("").Scope("")
	...
	// component: com33-filters0x5d53d8.IntentFilterForVscode
	cominfobuilder.Next()
	cominfobuilder.ID("com33-filters0x5d53d8.IntentFilterForVscode").Class("intent-filter-registry").Aliases("").Scope("")
	...
	// component: com36-filters0x5d53d8.IntentFilterForFirefox
	cominfobuilder.Next()
	cominfobuilder.ID("com36-filters0x5d53d8.IntentFilterForFirefox").Class("intent-filter-registry").Aliases("").Scope("")
	...
	// component: com37-filters0x5d53d8.IntentFilterFor
	cominfobuilder.Next()
	cominfobuilder.ID("com37-filters0x5d53d8.IntentFilterFor").Class("intent-filter-registry").Aliases("").Scope("")
	...
	// component: com38-filters0x5d53d8.ExecuteIntentFilter
	cominfobuilder.Next()
	cominfobuilder.ID("com38-filters0x5d53d8.ExecuteIntentFilter").Class("intent-filter-registry").Aliases("").Scope("")
	...
	// component: com41-filters0x5d53d8.IntentFilterForNautilus
	cominfobuilder.Next()
	cominfobuilder.ID("com41-filters0x5d53d8.IntentFilterForNautilus").Class("intent-filter-registry").Aliases("").Scope("")
	...
	// component: com42-filters0x5d53d8.IntentFilterForExplorer
	cominfobuilder.Next()
	cominfobuilder.ID("com42-filters0x5d53d8.IntentFilterForExplorer").Class("intent-filter-registry").Aliases("").Scope("")
	...
	// component: com44-handlers0x162741.FileSystemHandler
	cominfobuilder.Next()
	cominfobuilder.ID("com44-handlers0x162741.FileSystemHandler").Class("filequery-handler-registry").Aliases("").Scope("")
	...
	// component: com46-filter0x8aa8f6.HTTP404Filter
	cominfobuilder.Next()
	cominfobuilder.ID("com46-filter0x8aa8f6.HTTP404Filter").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com48-controller0x9dc399.ProjectController
	cominfobuilder.Next()
	cominfobuilder.ID("com48-controller0x9dc399.ProjectController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com49-controller0x9dc399.ExecutableController
	cominfobuilder.Next()
	cominfobuilder.ID("com49-controller0x9dc399.ExecutableController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com50-controller0x9dc399.AuthController
	cominfobuilder.Next()
	cominfobuilder.ID("com50-controller0x9dc399.AuthController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com51-controller0x9dc399.ExampleController
	cominfobuilder.Next()
	cominfobuilder.ID("com51-controller0x9dc399.ExampleController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com52-controller0x9dc399.ExecutableImportController
	cominfobuilder.Next()
	cominfobuilder.ID("com52-controller0x9dc399.ExecutableImportController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com53-controller0x9dc399.FileQueryController
	cominfobuilder.Next()
	cominfobuilder.ID("com53-controller0x9dc399.FileQueryController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com54-controller0x9dc399.RepositoryImportController
	cominfobuilder.Next()
	cominfobuilder.ID("com54-controller0x9dc399.RepositoryImportController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com56-controller0x9dc399.RemoteRepositoryController
	cominfobuilder.Next()
	cominfobuilder.ID("com56-controller0x9dc399.RemoteRepositoryController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com57-controller0x9dc399.RunIntentController
	cominfobuilder.Next()
	cominfobuilder.ID("com57-controller0x9dc399.RunIntentController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com58-controller0x9dc399.PlatformController
	cominfobuilder.Next()
	cominfobuilder.ID("com58-controller0x9dc399.PlatformController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com60-controller0x9dc399.ProjectImportController
	cominfobuilder.Next()
	cominfobuilder.ID("com60-controller0x9dc399.ProjectImportController").Class("rest-controller").Aliases("").Scope("")
...
// comFactory4pComLinuxPlatformServiceImpl : the factory of component: com3-implservice0x5a8f41.LinuxPlatformServiceImpl
...
// comFactory4pComWpmDataSource : the factory of component: com32-support0xf47d7f.WpmDataSource
...
func (inst * comFactory4pComWpmDataSource) getterForFieldDMSelector (context application.InstanceContext) datasource0x68a737.DriverManager {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com32-support0xf47d7f.WpmDataSource")
		eb.Set("field", "DM")
		eb.Set("type1", "?")
...
// comFactory4pComIntentFilterForVscode : the factory of component: com33-filters0x5d53d8.IntentFilterForVscode
...
// comFactory4pComIntentFilterForFirefox : the factory of component: com36-filters0x5d53d8.IntentFilterForFirefox
...
// comFactory4pComIntentFilterFor : the factory of component: com37-filters0x5d53d8.IntentFilterFor
...
// comFactory4pComExecuteIntentFilter : the factory of component: com38-filters0x5d53d8.ExecuteIntentFilter
...
func (inst * comFactory4pComExecuteIntentFilter) getterForFieldGitLibAgentSelector (context application.InstanceContext) store0x8467b3.LibAgent {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com38-filters0x5d53d8.ExecuteIntentFilter")
		eb.Set("field", "GitLibAgent")
		eb.Set("type1", "?")
		eb.Set("type2", "store0x8467b3.LibAgent")
		context.HandleError(eb.Create())
...
// comFactory4pComIntentFilterForNautilus : the factory of component: com41-filters0x5d53d8.IntentFilterForNautilus
...
// comFactory4pComIntentFilterForExplorer : the factory of component: com42-filters0x5d53d8.IntentFilterForExplorer
...
// comFactory4pComFileSystemHandler : the factory of component: com44-handlers0x162741.FileSystemHandler
...
// comFactory4pComHTTP404Filter : the factory of component: com46-filter0x8aa8f6.HTTP404Filter
...
// comFactory4pComProjectController : the factory of component: com48-controller0x9dc399.ProjectController
...
func (inst * comFactory4pComProjectController) getterForFieldProjectServiceSelector (context application.InstanceContext) service0x3e063d.ProjectService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com48-controller0x9dc399.ProjectController")
...
// comFactory4pComExecutableController : the factory of component: com49-controller0x9dc399.ExecutableController
...
func (inst * comFactory4pComExecutableController) getterForFieldExecutableServiceSelector (context application.InstanceContext) service0x3e063d.ExecutableService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com49-controller0x9dc399.ExecutableController")
		eb.Set("field", "ExecutableService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.ExecutableService")
		context.HandleError(eb.Create())
...
// comFactory4pComAuthController : the factory of component: com50-controller0x9dc399.AuthController
...
func (inst * comFactory4pComAuthController) getterForFieldResponderSelector (context application.InstanceContext) glass0x47343f.MainResponder {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com50-controller0x9dc399.AuthController")
		eb.Set("field", "Responder")
		eb.Set("type1", "?")
		eb.Set("type2", "glass0x47343f.MainResponder")
		context.HandleError(eb.Create())
...
// comFactory4pComExampleController : the factory of component: com51-controller0x9dc399.ExampleController
...
func (inst * comFactory4pComExampleController) getterForFieldResponderSelector (context application.InstanceContext) glass0x47343f.MainResponder {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com51-controller0x9dc399.ExampleController")
		eb.Set("field", "Responder")
		eb.Set("type1", "?")
		eb.Set("type2", "glass0x47343f.MainResponder")
		context.HandleError(eb.Create())
...
// comFactory4pComExecutableImportController : the factory of component: com52-controller0x9dc399.ExecutableImportController
...
func (inst * comFactory4pComExecutableImportController) getterForFieldExecutableImportServiceSelector (context application.InstanceContext) service0x3e063d.ExecutableImportService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com52-controller0x9dc399.ExecutableImportController")
...
// comFactory4pComFileQueryController : the factory of component: com53-controller0x9dc399.FileQueryController
...
func (inst * comFactory4pComFileQueryController) getterForFieldFileQueryServiceSelector (context application.InstanceContext) service0x3e063d.FileQueryService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com53-controller0x9dc399.FileQueryController")
...
// comFactory4pComRepositoryImportController : the factory of component: com54-controller0x9dc399.RepositoryImportController
...
func (inst * comFactory4pComRepositoryImportController) getterForFieldRepoStateLoaderSelector (context application.InstanceContext) service0x3e063d.LocalRepositoryStateLoader {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com54-controller0x9dc399.RepositoryImportController")
...
// comFactory4pComRemoteRepositoryController : the factory of component: com56-controller0x9dc399.RemoteRepositoryController
...
func (inst * comFactory4pComRemoteRepositoryController) getterForFieldRepoServiceSelector (context application.InstanceContext) service0x3e063d.RemoteRepositoryService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com56-controller0x9dc399.RemoteRepositoryController")
		eb.Set("field", "RepoService")
		eb.Set("type1", "?")
...
// comFactory4pComRunIntentController : the factory of component: com57-controller0x9dc399.RunIntentController
...
func (inst * comFactory4pComRunIntentController) getterForFieldIntentServiceSelector (context application.InstanceContext) service0x3e063d.IntentService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com57-controller0x9dc399.RunIntentController")
...
// comFactory4pComPlatformController : the factory of component: com58-controller0x9dc399.PlatformController
...
func (inst * comFactory4pComPlatformController) getterForFieldPlatformServiceSelector (context application.InstanceContext) service0x3e063d.PlatformService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com58-controller0x9dc399.PlatformController")
		eb.Set("field", "PlatformService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.PlatformService")
		context.HandleError(eb.Create())
...
// comFactory4pComProjectImportController : the factory of component: com60-controller0x9dc399.ProjectImportController
...
func (inst * comFactory4pComProjectImportController) getterForFieldProjectImportServiceSelector (context application.InstanceContext) service0x3e063d.ProjectImportService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com60-controller0x9dc399.ProjectImportController")
