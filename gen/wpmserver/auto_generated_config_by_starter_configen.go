...
import (
	...
	packs0xfbb07e "github.com/bitwormhole/wpm/server/components/packs"
	...
	filequery0x34ec39 "github.com/bitwormhole/wpm/server/support/filequery"
...
func autoGenConfig(cb application.ConfigBuilder) error {
	...
	// component: com3-init0xc984bc.WpmInitController
	cominfobuilder.Next()
	cominfobuilder.ID("com3-init0xc984bc.WpmInitController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com4-settings0x19237d.SettingController
	cominfobuilder.Next()
	cominfobuilder.ID("com4-settings0x19237d.SettingController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com8-repositoryworktreeproject0x399028.RepoWorktreeProjectController
	cominfobuilder.Next()
	cominfobuilder.ID("com8-repositoryworktreeproject0x399028.RepoWorktreeProjectController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com13-intents0x8ee0e0.RunIntentController
	cominfobuilder.Next()
	cominfobuilder.ID("com13-intents0x8ee0e0.RunIntentController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com16-filequery0x34ec39.FileQueryController
	cominfobuilder.Next()
	cominfobuilder.ID("com16-filequery0x34ec39.FileQueryController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com19-plugins0x82e34b.WPMPluginInstaller
	cominfobuilder.Next()
	cominfobuilder.ID("com19-plugins0x82e34b.WPMPluginInstaller").Class("life packs.InstallerRegistry").Aliases("").Scope("")
	cominfobuilder.Factory((&comFactory4pComWPMPluginInstaller{}).init())
	err = cominfobuilder.CreateTo(cb)
	if err != nil {
		return err
	}
	...
	// component: com21-plugins0x82e34b.SoftwarePackageController
	cominfobuilder.Next()
	cominfobuilder.ID("com21-plugins0x82e34b.SoftwarePackageController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: InstalledFileDAO
	cominfobuilder.Next()
	cominfobuilder.ID("InstalledFileDAO").Class("").Aliases("").Scope("")
	cominfobuilder.Factory((&comFactory4pComSoftInstalledFileDAO{}).init())
	err = cominfobuilder.CreateTo(cb)
	if err != nil {
		return err
	}

	// component: com24-plugins0x82e34b.SoftwareSetController
	cominfobuilder.Next()
	cominfobuilder.ID("com24-plugins0x82e34b.SoftwareSetController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: IntentTemplateEntityCache
	cominfobuilder.Next()
	cominfobuilder.ID("IntentTemplateEntityCache").Class("").Aliases("").Scope("")
	cominfobuilder.Factory((&comFactory4pComImpIntentTemplateEntityCache{}).init())
	err = cominfobuilder.CreateTo(cb)
	if err != nil {
		return err
	}
	...
	// component: com28-intenttemplates0x2e3dcf.IntentTemplateController
	cominfobuilder.Next()
	cominfobuilder.ID("com28-intenttemplates0x2e3dcf.IntentTemplateController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: HTTPClientExService
	cominfobuilder.Next()
	cominfobuilder.ID("HTTPClientExService").Class("").Aliases("").Scope("")
	cominfobuilder.Factory((&comFactory4pComImpHTTPClientEx{}).init())
	err = cominfobuilder.CreateTo(cb)
	if err != nil {
		return err
	}
	...
	// component: com31-contenttypes0x61ca37.ProjectTypeImportController
	cominfobuilder.Next()
	cominfobuilder.ID("com31-contenttypes0x61ca37.ProjectTypeImportController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com33-contenttypes0x61ca37.ContentTypeController
	cominfobuilder.Next()
	cominfobuilder.ID("com33-contenttypes0x61ca37.ContentTypeController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com39-mediae0xf005e2.MediaController
	cominfobuilder.Next()
	cominfobuilder.ID("com39-mediae0xf005e2.MediaController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com42-projects0x4d85c7.ProjectController
	cominfobuilder.Next()
	cominfobuilder.ID("com42-projects0x4d85c7.ProjectController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com46-projects0x4d85c7.ProjectImportController
	cominfobuilder.Next()
	cominfobuilder.ID("com46-projects0x4d85c7.ProjectImportController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com47-jsonbuffer0x988f20.JSONBufferController
	cominfobuilder.Next()
	cominfobuilder.ID("com47-jsonbuffer0x988f20.JSONBufferController").Class("rest-controller").Aliases("").Scope("")
	cominfobuilder.Factory((&comFactory4pComJSONBufferController{}).init())
	err = cominfobuilder.CreateTo(cb)
	if err != nil {
		return err
	}

	// component: JSONBufferService
	cominfobuilder.Next()
	cominfobuilder.ID("JSONBufferService").Class("").Aliases("").Scope("")
	cominfobuilder.Factory((&comFactory4pComImpJSONBufferService{}).init())
	err = cominfobuilder.CreateTo(cb)
	if err != nil {
		return err
	}
	...
	// component: com50-repositories0x637d5e.LocalRepositoryController
	cominfobuilder.Next()
	cominfobuilder.ID("com50-repositories0x637d5e.LocalRepositoryController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com53-repositories0x637d5e.RepositoryImportController
	cominfobuilder.Next()
	cominfobuilder.ID("com53-repositories0x637d5e.RepositoryImportController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com56-repositories0x637d5e.RemoteRepositoryController
	cominfobuilder.Next()
	cominfobuilder.ID("com56-repositories0x637d5e.RemoteRepositoryController").Class("rest-controller").Aliases("").Scope("")
	...
	cominfobuilder.Next()
	cominfobuilder.ID("OptionService").Class("").Aliases("").Scope("")
	cominfobuilder.Factory((&comFactory4pComImpOptionService{}).init())
	err = cominfobuilder.CreateTo(cb)
	if err != nil {
		return err
	}

	// component: com60-options0x10c3ff.TheOptionController
	cominfobuilder.Next()
	cominfobuilder.ID("com60-options0x10c3ff.TheOptionController").Class("rest-controller").Aliases("").Scope("")
	cominfobuilder.Factory((&comFactory4pComTheOptionController{}).init())
	err = cominfobuilder.CreateTo(cb)
	if err != nil {
		return err
	}

	// component: com61-trash0xd00f34.TheTrashController
	cominfobuilder.Next()
	cominfobuilder.ID("com61-trash0xd00f34.TheTrashController").Class("rest-controller").Aliases("").Scope("")
	cominfobuilder.Factory((&comFactory4pComTheTrashController{}).init())
	err = cominfobuilder.CreateTo(cb)
	if err != nil {
		return err
	}

	// component: TrashService
	cominfobuilder.Next()
	cominfobuilder.ID("TrashService").Class("").Aliases("").Scope("")
	cominfobuilder.Factory((&comFactory4pComImpTrashService{}).init())
	err = cominfobuilder.CreateTo(cb)
	if err != nil {
		return err
	}
	...
	// component: TrashDAO
	cominfobuilder.Next()
	cominfobuilder.ID("TrashDAO").Class("").Aliases("").Scope("")
	cominfobuilder.Factory((&comFactory4pComImpTrashDao{}).init())
	err = cominfobuilder.CreateTo(cb)
	if err != nil {
		return err
	}
	...
	// component: com65-setup0xd9ff02.WpmSetupController
	cominfobuilder.Next()
	cominfobuilder.ID("com65-setup0xd9ff02.WpmSetupController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com68-namespaces0xceefcf.NamespaceController
	cominfobuilder.Next()
	cominfobuilder.ID("com68-namespaces0xceefcf.NamespaceController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com71-statistics0x0575cd.TheStatisticController
	cominfobuilder.Next()
	cominfobuilder.ID("com71-statistics0x0575cd.TheStatisticController").Class("rest-controller").Aliases("").Scope("")
	cominfobuilder.Factory((&comFactory4pComTheStatisticController{}).init())
	err = cominfobuilder.CreateTo(cb)
	if err != nil {
		return err
	}
	...
	cominfobuilder.Next()
	cominfobuilder.ID("StatisticDAO").Class("").Aliases("").Scope("")
	cominfobuilder.Factory((&comFactory4pComImpStatisticDao{}).init())
	err = cominfobuilder.CreateTo(cb)
	if err != nil {
		return err
	}
	...
	// component: com80-support0xf47d7f.WpmDataSource
	cominfobuilder.Next()
	cominfobuilder.ID("com80-support0xf47d7f.WpmDataSource").Class("starter-gorm-source-registry").Aliases("").Scope("")
	...
	// component: com81-platforms0xb539c0.WindowsPlatformServiceImpl
	cominfobuilder.Next()
	cominfobuilder.ID("com81-platforms0xb539c0.WindowsPlatformServiceImpl").Class("PlatformProviderRegistry").Aliases("").Scope("")
	...
	// component: com84-platforms0xb539c0.LinuxPlatformServiceImpl
	cominfobuilder.Next()
	cominfobuilder.ID("com84-platforms0xb539c0.LinuxPlatformServiceImpl").Class("PlatformProviderRegistry").Aliases("").Scope("")
	...
	// component: com86-executables0xd3773a.ExecutableController
	cominfobuilder.Next()
	cominfobuilder.ID("com86-executables0xd3773a.ExecutableController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com88-executables0xd3773a.ExecutableImportController
	cominfobuilder.Next()
	cominfobuilder.ID("com88-executables0xd3773a.ExecutableImportController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com91-handlers0x162741.FileSystemHandler
	cominfobuilder.Next()
	cominfobuilder.ID("com91-handlers0x162741.FileSystemHandler").Class("filequery-handler-registry").Aliases("").Scope("")
	...
	// component: com92-v3filters0xa6552a.FindTemplateFilter
	cominfobuilder.Next()
	cominfobuilder.ID("com92-v3filters0xa6552a.FindTemplateFilter").Class("wpm-intent-filter").Aliases("").Scope("")
	...
	// component: com93-v3filters0xa6552a.CLIRunnerFilter
	cominfobuilder.Next()
	cominfobuilder.ID("com93-v3filters0xa6552a.CLIRunnerFilter").Class("wpm-intent-filter").Aliases("").Scope("")
	...
	// component: com94-v3filters0xa6552a.CheckTemplateFilter
	cominfobuilder.Next()
	cominfobuilder.ID("com94-v3filters0xa6552a.CheckTemplateFilter").Class("wpm-intent-filter").Aliases("").Scope("")
	...
	// component: com95-v3filters0xa6552a.PrepareActionFilter
	cominfobuilder.Next()
	cominfobuilder.ID("com95-v3filters0xa6552a.PrepareActionFilter").Class("wpm-intent-filter").Aliases("").Scope("")
	...
	// component: com96-v3filters0xa6552a.CLIMakerFilter
	cominfobuilder.Next()
	cominfobuilder.ID("com96-v3filters0xa6552a.CLIMakerFilter").Class("wpm-intent-filter").Aliases("").Scope("")
	...
	// component: com97-v3filters0xa6552a.PreparePropertiesFilter
	cominfobuilder.Next()
	cominfobuilder.ID("com97-v3filters0xa6552a.PreparePropertiesFilter").Class("wpm-intent-filter").Aliases("").Scope("")
	...
	// component: com98-v3filters0xa6552a.ExampleFilter
	cominfobuilder.Next()
	cominfobuilder.ID("com98-v3filters0xa6552a.ExampleFilter").Class("wpm-intent-filter").Aliases("").Scope("")
	...
	// component: com99-filter0x8aa8f6.HostFilter
	cominfobuilder.Next()
	cominfobuilder.ID("com99-filter0x8aa8f6.HostFilter").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com100-filter0x8aa8f6.HTTP404Filter
	cominfobuilder.Next()
	cominfobuilder.ID("com100-filter0x8aa8f6.HTTP404Filter").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com101-controller0x9dc399.OnlineDocumentExampleController
	cominfobuilder.Next()
	cominfobuilder.ID("com101-controller0x9dc399.OnlineDocumentExampleController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com102-controller0x9dc399.AuthController
	cominfobuilder.Next()
	cominfobuilder.ID("com102-controller0x9dc399.AuthController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com103-controller0x9dc399.ExampleController
	cominfobuilder.Next()
	cominfobuilder.ID("com103-controller0x9dc399.ExampleController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com104-controller0x9dc399.UploadController
	cominfobuilder.Next()
	cominfobuilder.ID("com104-controller0x9dc399.UploadController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com105-controller0x9dc399.PlatformController
	cominfobuilder.Next()
	cominfobuilder.ID("com105-controller0x9dc399.PlatformController").Class("rest-controller").Aliases("").Scope("")
	...
	// component: com106-controller0x9dc399.AboutController
	cominfobuilder.Next()
	cominfobuilder.ID("com106-controller0x9dc399.AboutController").Class("rest-controller").Aliases("").Scope("")
...
type comFactory4pComImpInitService struct {
	...
	mOptionServiceSelector config.InjectionSelector
...
func (inst * comFactory4pComImpInitService) init() application.ComponentFactory {
	...
	inst.mOptionServiceSelector = config.NewInjectionSelector("#OptionService",nil)
...
func (inst * comFactory4pComImpInitService) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
	...
	obj.OptionService = inst.getterForFieldOptionServiceSelector(context)
	return context.LastError()
}
...
//getterForFieldOptionServiceSelector
func (inst * comFactory4pComImpInitService) getterForFieldOptionServiceSelector (context application.InstanceContext) service0x3e063d.OptionService {

	o1 := inst.mOptionServiceSelector.GetOne(context)
	o2, ok := o1.(service0x3e063d.OptionService)
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "InitService")
		eb.Set("field", "OptionService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.OptionService")
		context.HandleError(eb.Create())
		return nil
	}
	return o2
...
// comFactory4pComWpmInitController : the factory of component: com3-init0xc984bc.WpmInitController
...
func (inst * comFactory4pComWpmInitController) getterForFieldInitServiceSelector (context application.InstanceContext) service0x3e063d.InitService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com3-init0xc984bc.WpmInitController")
...
// comFactory4pComSettingController : the factory of component: com4-settings0x19237d.SettingController
...
func (inst * comFactory4pComSettingController) getterForFieldSettingServiceSelector (context application.InstanceContext) service0x3e063d.SettingService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com4-settings0x19237d.SettingController")
...
// comFactory4pComRepoWorktreeProjectController : the factory of component: com8-repositoryworktreeproject0x399028.RepoWorktreeProjectController
...
func (inst * comFactory4pComRepoWorktreeProjectController) getterForFieldRWPServiceSelector (context application.InstanceContext) service0x3e063d.RepositoryWorktreeProjectService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com8-repositoryworktreeproject0x399028.RepoWorktreeProjectController")
...
// comFactory4pComRunIntentController : the factory of component: com13-intents0x8ee0e0.RunIntentController
...
func (inst * comFactory4pComRunIntentController) getterForFieldIntentServiceSelector (context application.InstanceContext) service0x3e063d.IntentService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com13-intents0x8ee0e0.RunIntentController")
...
// comFactory4pComFileQueryController : the factory of component: com16-filequery0x34ec39.FileQueryController
type comFactory4pComFileQueryController struct {

    mPrototype * filequery0x34ec39.FileQueryController
...
func (inst * comFactory4pComFileQueryController) newObject() * filequery0x34ec39.FileQueryController {
	return & filequery0x34ec39.FileQueryController {}
}

func (inst * comFactory4pComFileQueryController) castObject(instance application.ComponentInstance) * filequery0x34ec39.FileQueryController {
	return instance.Get().(*filequery0x34ec39.FileQueryController)
}
...
func (inst * comFactory4pComFileQueryController) getterForFieldFileQueryServiceSelector (context application.InstanceContext) service0x3e063d.FileQueryService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com16-filequery0x34ec39.FileQueryController")
...
type comFactory4pComFileQueryServiceImpl struct {
    ...
    mPrototype * filequery0x34ec39.FileQueryServiceImpl
...
func (inst * comFactory4pComFileQueryServiceImpl) newObject() * filequery0x34ec39.FileQueryServiceImpl {
	return & filequery0x34ec39.FileQueryServiceImpl {}
}

func (inst * comFactory4pComFileQueryServiceImpl) castObject(instance application.ComponentInstance) * filequery0x34ec39.FileQueryServiceImpl {
	return instance.Get().(*filequery0x34ec39.FileQueryServiceImpl)
}
...
func (inst * comFactory4pComFileQueryServiceImpl) getterForFieldContentTypeServiceSelector (context application.InstanceContext) service0x3e063d.ContentTypeService {
...
// comFactory4pComWPMPluginInstaller : the factory of component: com19-plugins0x82e34b.WPMPluginInstaller
type comFactory4pComWPMPluginInstaller struct {
...
func (inst * comFactory4pComWPMPluginInstaller) newObject() * plugins0x82e34b.WPMPluginInstaller {
	return & plugins0x82e34b.WPMPluginInstaller {}
}

func (inst * comFactory4pComWPMPluginInstaller) castObject(instance application.ComponentInstance) * plugins0x82e34b.WPMPluginInstaller {
	return instance.Get().(*plugins0x82e34b.WPMPluginInstaller)
}

func (inst * comFactory4pComWPMPluginInstaller) GetPrototype() lang.Object {
	return inst.mPrototype
}

func (inst * comFactory4pComWPMPluginInstaller) NewInstance() application.ComponentInstance {
	return config.SimpleInstance(inst, inst.newObject())
}

func (inst * comFactory4pComWPMPluginInstaller) AfterService() application.ComponentAfterService {
	return inst
}

func (inst * comFactory4pComWPMPluginInstaller) Init(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComWPMPluginInstaller) Destroy(instance application.ComponentInstance) error {
	return nil
}
...
func (inst * comFactory4pComWPMPluginInstaller) getterForFieldHTTPClientExServiceSelector (context application.InstanceContext) service0x3e063d.HTTPClientExService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com19-plugins0x82e34b.WPMPluginInstaller")
...
//getterForFieldFileSystemServiceSelector
func (inst * comFactory4pComWPMPluginInstaller) getterForFieldFileSystemServiceSelector (context application.InstanceContext) service0x3e063d.FileSystemService {
...
//getterForFieldContentTypeServiceSelector
func (inst * comFactory4pComWPMPluginInstaller) getterForFieldContentTypeServiceSelector (context application.InstanceContext) service0x3e063d.ContentTypeService {
...
//getterForFieldInstalledFileDAOSelector
func (inst * comFactory4pComWPMPluginInstaller) getterForFieldInstalledFileDAOSelector (context application.InstanceContext) dao0x5af8d0.InstalledFileDAO {

	o1 := inst.mInstalledFileDAOSelector.GetOne(context)
	o2, ok := o1.(dao0x5af8d0.InstalledFileDAO)
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com19-plugins0x82e34b.WPMPluginInstaller")
		eb.Set("field", "InstalledFileDAO")
		eb.Set("type1", "?")
		eb.Set("type2", "dao0x5af8d0.InstalledFileDAO")
		context.HandleError(eb.Create())
		return nil
	}
	return o2
...
// comFactory4pComSoftwarePackageController : the factory of component: com21-plugins0x82e34b.SoftwarePackageController
...
func (inst * comFactory4pComSoftwarePackageController) getterForFieldSoftwarePackageServiceSelector (context application.InstanceContext) service0x3e063d.SoftwarePackageService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com21-plugins0x82e34b.SoftwarePackageController")
		eb.Set("field", "SoftwarePackageService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.SoftwarePackageService")
		context.HandleError(eb.Create())
...
type comFactory4pComPluginServiceImpl struct {
	...
	mAppDataServiceSelector config.InjectionSelector
	mFileSystemServiceSelector config.InjectionSelector
	mInstallerRegistryListSelector config.InjectionSelector
...
func (inst * comFactory4pComPluginServiceImpl) init() application.ComponentFactory {
	...
	inst.mAppDataServiceSelector = config.NewInjectionSelector("#AppDataService",nil)
	inst.mFileSystemServiceSelector = config.NewInjectionSelector("#FileSystemService",nil)
	inst.mInstallerRegistryListSelector = config.NewInjectionSelector(".packs.InstallerRegistry",nil)
...
func (inst * comFactory4pComPluginServiceImpl) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
	...
	obj.AppDataService = inst.getterForFieldAppDataServiceSelector(context)
	obj.FileSystemService = inst.getterForFieldFileSystemServiceSelector(context)
	obj.InstallerRegistryList = inst.getterForFieldInstallerRegistryListSelector(context)
	return context.LastError()
}
...
//getterForFieldTrashServiceSelector
func (inst * comFactory4pComPluginServiceImpl) getterForFieldTrashServiceSelector (context application.InstanceContext) service0x3e063d.TrashService {
...
//getterForFieldAppDataServiceSelector
func (inst * comFactory4pComPluginServiceImpl) getterForFieldAppDataServiceSelector (context application.InstanceContext) service0x3e063d.AppDataService {
...
//getterForFieldFileSystemServiceSelector
func (inst * comFactory4pComPluginServiceImpl) getterForFieldFileSystemServiceSelector (context application.InstanceContext) service0x3e063d.FileSystemService {
...
//getterForFieldInstallerRegistryListSelector
func (inst * comFactory4pComPluginServiceImpl) getterForFieldInstallerRegistryListSelector (context application.InstanceContext) []packs0xfbb07e.InstallerRegistry {
	list1 := inst.mInstallerRegistryListSelector.GetList(context)
	list2 := make([]packs0xfbb07e.InstallerRegistry, 0, len(list1))
	for _, item1 := range list1 {
		item2, ok := item1.(packs0xfbb07e.InstallerRegistry)
		if ok {
			list2 = append(list2, item2)
		}
	}
...
// comFactory4pComSoftInstalledFileDAO : the factory of component: InstalledFileDAO
type comFactory4pComSoftInstalledFileDAO struct {

    mPrototype * plugins0x82e34b.SoftInstalledFileDAO
...
func (inst * comFactory4pComSoftInstalledFileDAO) init() application.ComponentFactory {
...
func (inst * comFactory4pComSoftInstalledFileDAO) newObject() * plugins0x82e34b.SoftInstalledFileDAO {
	return & plugins0x82e34b.SoftInstalledFileDAO {}
}

func (inst * comFactory4pComSoftInstalledFileDAO) castObject(instance application.ComponentInstance) * plugins0x82e34b.SoftInstalledFileDAO {
	return instance.Get().(*plugins0x82e34b.SoftInstalledFileDAO)
}

func (inst * comFactory4pComSoftInstalledFileDAO) GetPrototype() lang.Object {
	return inst.mPrototype
}

func (inst * comFactory4pComSoftInstalledFileDAO) NewInstance() application.ComponentInstance {
	return config.SimpleInstance(inst, inst.newObject())
}

func (inst * comFactory4pComSoftInstalledFileDAO) AfterService() application.ComponentAfterService {
	return inst
}

func (inst * comFactory4pComSoftInstalledFileDAO) Init(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComSoftInstalledFileDAO) Destroy(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComSoftInstalledFileDAO) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
...
//getterForFieldAgentSelector
func (inst * comFactory4pComSoftInstalledFileDAO) getterForFieldAgentSelector (context application.InstanceContext) dbagent0x9f90fb.GormDBAgent {
...
//getterForFieldTrashServiceSelector
func (inst * comFactory4pComSoftInstalledFileDAO) getterForFieldTrashServiceSelector (context application.InstanceContext) service0x3e063d.TrashService {
...
//getterForFieldUUIDGenServiceSelector
func (inst * comFactory4pComSoftInstalledFileDAO) getterForFieldUUIDGenServiceSelector (context application.InstanceContext) service0x3e063d.UUIDGenService {
...
// comFactory4pComSoftwareSetController : the factory of component: com24-plugins0x82e34b.SoftwareSetController
...
func (inst * comFactory4pComSoftwareSetController) getterForFieldSoftwareSetServiceSelector (context application.InstanceContext) service0x3e063d.SoftwareSetService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com24-plugins0x82e34b.SoftwareSetController")
...
// comFactory4pComImpIntentTemplateEntityCache : the factory of component: IntentTemplateEntityCache
type comFactory4pComImpIntentTemplateEntityCache struct {

    mPrototype * intenttemplates0x2e3dcf.ImpIntentTemplateEntityCache
...
func (inst * comFactory4pComImpIntentTemplateEntityCache) init() application.ComponentFactory {

	
	inst.mDAOSelector = config.NewInjectionSelector("#IntentTemplateDAO",nil)
...
func (inst * comFactory4pComImpIntentTemplateEntityCache) newObject() * intenttemplates0x2e3dcf.ImpIntentTemplateEntityCache {
	return & intenttemplates0x2e3dcf.ImpIntentTemplateEntityCache {}
}

func (inst * comFactory4pComImpIntentTemplateEntityCache) castObject(instance application.ComponentInstance) * intenttemplates0x2e3dcf.ImpIntentTemplateEntityCache {
	return instance.Get().(*intenttemplates0x2e3dcf.ImpIntentTemplateEntityCache)
}

func (inst * comFactory4pComImpIntentTemplateEntityCache) GetPrototype() lang.Object {
	return inst.mPrototype
}

func (inst * comFactory4pComImpIntentTemplateEntityCache) NewInstance() application.ComponentInstance {
	return config.SimpleInstance(inst, inst.newObject())
}

func (inst * comFactory4pComImpIntentTemplateEntityCache) AfterService() application.ComponentAfterService {
	return inst
}

func (inst * comFactory4pComImpIntentTemplateEntityCache) Init(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComImpIntentTemplateEntityCache) Destroy(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComImpIntentTemplateEntityCache) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
...
//getterForFieldDAOSelector
func (inst * comFactory4pComImpIntentTemplateEntityCache) getterForFieldDAOSelector (context application.InstanceContext) dao0x5af8d0.IntentTemplateDAO {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "IntentTemplateEntityCache")
		eb.Set("field", "DAO")
		eb.Set("type1", "?")
...
type comFactory4pComIntentTemplateServiceImpl struct {
	...
	mTemplateCacheSelector config.InjectionSelector
...
func (inst * comFactory4pComIntentTemplateServiceImpl) init() application.ComponentFactory {
	...
	inst.mTemplateCacheSelector = config.NewInjectionSelector("#IntentTemplateEntityCache",nil)
...
func (inst * comFactory4pComIntentTemplateServiceImpl) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
	...
	obj.TemplateCache = inst.getterForFieldTemplateCacheSelector(context)
	return context.LastError()
}
...
//getterForFieldTemplateCacheSelector
func (inst * comFactory4pComIntentTemplateServiceImpl) getterForFieldTemplateCacheSelector (context application.InstanceContext) service0x3e063d.IntentTemplateEntityCache {

	o1 := inst.mTemplateCacheSelector.GetOne(context)
	o2, ok := o1.(service0x3e063d.IntentTemplateEntityCache)
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "IntentTemplateService")
		eb.Set("field", "TemplateCache")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.IntentTemplateEntityCache")
		context.HandleError(eb.Create())
		return nil
	}
	return o2
...
// comFactory4pComIntentTemplateController : the factory of component: com28-intenttemplates0x2e3dcf.IntentTemplateController
...
func (inst * comFactory4pComIntentTemplateController) getterForFieldIntentTemplateServiceSelector (context application.InstanceContext) service0x3e063d.IntentTemplateService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com28-intenttemplates0x2e3dcf.IntentTemplateController")
		eb.Set("field", "IntentTemplateService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.IntentTemplateService")
		context.HandleError(eb.Create())
...
// comFactory4pComImpHTTPClientEx : the factory of component: HTTPClientExService
type comFactory4pComImpHTTPClientEx struct {

    mPrototype * httpclient0xf20fe2.ImpHTTPClientEx
...
func (inst * comFactory4pComImpHTTPClientEx) init() application.ComponentFactory {
...
func (inst * comFactory4pComImpHTTPClientEx) newObject() * httpclient0xf20fe2.ImpHTTPClientEx {
	return & httpclient0xf20fe2.ImpHTTPClientEx {}
}

func (inst * comFactory4pComImpHTTPClientEx) castObject(instance application.ComponentInstance) * httpclient0xf20fe2.ImpHTTPClientEx {
	return instance.Get().(*httpclient0xf20fe2.ImpHTTPClientEx)
}

func (inst * comFactory4pComImpHTTPClientEx) GetPrototype() lang.Object {
	return inst.mPrototype
}

func (inst * comFactory4pComImpHTTPClientEx) NewInstance() application.ComponentInstance {
	return config.SimpleInstance(inst, inst.newObject())
}

func (inst * comFactory4pComImpHTTPClientEx) AfterService() application.ComponentAfterService {
	return inst
}

func (inst * comFactory4pComImpHTTPClientEx) Init(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComImpHTTPClientEx) Destroy(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComImpHTTPClientEx) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
...
func (inst * comFactory4pComImpHTTPClientEx) getterForFieldHTTPClientServiceSelector (context application.InstanceContext) service0x3e063d.HTTPClientService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "HTTPClientExService")
...
// comFactory4pComProjectTypeImportController : the factory of component: com31-contenttypes0x61ca37.ProjectTypeImportController
...
func (inst * comFactory4pComProjectTypeImportController) getterForFieldProjectTypeImportServiceSelector (context application.InstanceContext) service0x3e063d.ProjectTypeImportService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com31-contenttypes0x61ca37.ProjectTypeImportController")
...
// comFactory4pComContentTypeController : the factory of component: com33-contenttypes0x61ca37.ContentTypeController
...
func (inst * comFactory4pComContentTypeController) getterForFieldContentTypeServiceSelector (context application.InstanceContext) service0x3e063d.ContentTypeService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com33-contenttypes0x61ca37.ContentTypeController")
		eb.Set("field", "ContentTypeService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.ContentTypeService")
		context.HandleError(eb.Create())
...
type comFactory4pComCacheProvider struct {
	...
	mHTCSelector config.InjectionSelector
...
func (inst * comFactory4pComCacheProvider) init() application.ComponentFactory {
	...
	inst.mHTCSelector = config.NewInjectionSelector("#HTTPClientExService",nil)
...
func (inst * comFactory4pComCacheProvider) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
	...
	obj.HTC = inst.getterForFieldHTCSelector(context)
...
//getterForFieldHTCSelector
func (inst * comFactory4pComCacheProvider) getterForFieldHTCSelector (context application.InstanceContext) service0x3e063d.HTTPClientExService {

	o1 := inst.mHTCSelector.GetOne(context)
	o2, ok := o1.(service0x3e063d.HTTPClientExService)
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
...
// comFactory4pComMediaController : the factory of component: com39-mediae0xf005e2.MediaController
...
func (inst * comFactory4pComMediaController) getterForFieldFileSystemServiceSelector (context application.InstanceContext) service0x3e063d.FileSystemService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com39-mediae0xf005e2.MediaController")
		eb.Set("field", "FileSystemService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.FileSystemService")
		context.HandleError(eb.Create())
...
func (inst * comFactory4pComMediaServiceImpl) init() application.ComponentFactory {
	...
	inst.mContentTypeServiceSelector = config.NewInjectionSelector("#ContentTypeService",nil)
	inst.mHTTPClientServiceSelector = config.NewInjectionSelector("#HTTPClientService",nil)
	inst.mResPathPrefixSelector = config.NewInjectionSelector("${wpm.presets.res-path-prefix-list}",nil)
...
//getterForFieldHTTPClientServiceSelector
func (inst * comFactory4pComMediaServiceImpl) getterForFieldHTTPClientServiceSelector (context application.InstanceContext) service0x3e063d.HTTPClientService {
...
// comFactory4pComProjectController : the factory of component: com42-projects0x4d85c7.ProjectController
...
func (inst * comFactory4pComProjectController) getterForFieldProjectServiceSelector (context application.InstanceContext) service0x3e063d.ProjectService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com42-projects0x4d85c7.ProjectController")
...
// comFactory4pComProjectImportController : the factory of component: com46-projects0x4d85c7.ProjectImportController
...
func (inst * comFactory4pComProjectImportController) getterForFieldProjectImportServiceSelector (context application.InstanceContext) service0x3e063d.ProjectImportService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com46-projects0x4d85c7.ProjectImportController")
...
// comFactory4pComJSONBufferController : the factory of component: com47-jsonbuffer0x988f20.JSONBufferController
type comFactory4pComJSONBufferController struct {

    mPrototype * jsonbuffer0x988f20.JSONBufferController

	
	mJSONBufferServiceSelector config.InjectionSelector
	mResponderSelector config.InjectionSelector

}

func (inst * comFactory4pComJSONBufferController) init() application.ComponentFactory {

	
	inst.mJSONBufferServiceSelector = config.NewInjectionSelector("#JSONBufferService",nil)
	inst.mResponderSelector = config.NewInjectionSelector("#glass-main-responder",nil)
...
func (inst * comFactory4pComJSONBufferController) newObject() * jsonbuffer0x988f20.JSONBufferController {
	return & jsonbuffer0x988f20.JSONBufferController {}
}

func (inst * comFactory4pComJSONBufferController) castObject(instance application.ComponentInstance) * jsonbuffer0x988f20.JSONBufferController {
	return instance.Get().(*jsonbuffer0x988f20.JSONBufferController)
}

func (inst * comFactory4pComJSONBufferController) GetPrototype() lang.Object {
	return inst.mPrototype
}

func (inst * comFactory4pComJSONBufferController) NewInstance() application.ComponentInstance {
	return config.SimpleInstance(inst, inst.newObject())
}

func (inst * comFactory4pComJSONBufferController) AfterService() application.ComponentAfterService {
	return inst
}

func (inst * comFactory4pComJSONBufferController) Init(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComJSONBufferController) Destroy(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComJSONBufferController) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
	
	obj := inst.castObject(instance)
	obj.JSONBufferService = inst.getterForFieldJSONBufferServiceSelector(context)
	obj.Responder = inst.getterForFieldResponderSelector(context)
	return context.LastError()
}

//getterForFieldJSONBufferServiceSelector
func (inst * comFactory4pComJSONBufferController) getterForFieldJSONBufferServiceSelector (context application.InstanceContext) service0x3e063d.JSONBufferService {

	o1 := inst.mJSONBufferServiceSelector.GetOne(context)
	o2, ok := o1.(service0x3e063d.JSONBufferService)
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com47-jsonbuffer0x988f20.JSONBufferController")
		eb.Set("field", "JSONBufferService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.JSONBufferService")
		context.HandleError(eb.Create())
		return nil
	}
	return o2
...
//getterForFieldResponderSelector
func (inst * comFactory4pComJSONBufferController) getterForFieldResponderSelector (context application.InstanceContext) glass0x47343f.MainResponder {
...
// comFactory4pComImpJSONBufferService : the factory of component: JSONBufferService
type comFactory4pComImpJSONBufferService struct {

    mPrototype * jsonbuffer0x988f20.ImpJSONBufferService

	

}

func (inst * comFactory4pComImpJSONBufferService) init() application.ComponentFactory {
...
func (inst * comFactory4pComImpJSONBufferService) newObject() * jsonbuffer0x988f20.ImpJSONBufferService {
	return & jsonbuffer0x988f20.ImpJSONBufferService {}
}

func (inst * comFactory4pComImpJSONBufferService) castObject(instance application.ComponentInstance) * jsonbuffer0x988f20.ImpJSONBufferService {
	return instance.Get().(*jsonbuffer0x988f20.ImpJSONBufferService)
}

func (inst * comFactory4pComImpJSONBufferService) GetPrototype() lang.Object {
	return inst.mPrototype
}

func (inst * comFactory4pComImpJSONBufferService) NewInstance() application.ComponentInstance {
	return config.SimpleInstance(inst, inst.newObject())
}

func (inst * comFactory4pComImpJSONBufferService) AfterService() application.ComponentAfterService {
	return inst
}

func (inst * comFactory4pComImpJSONBufferService) Init(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComImpJSONBufferService) Destroy(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComImpJSONBufferService) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
	return nil
}
...
// comFactory4pComLocalRepositoryController : the factory of component: com50-repositories0x637d5e.LocalRepositoryController
...
func (inst * comFactory4pComLocalRepositoryController) getterForFieldRepoServiceSelector (context application.InstanceContext) service0x3e063d.LocalRepositoryService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com50-repositories0x637d5e.LocalRepositoryController")
...
// comFactory4pComRepositoryImportController : the factory of component: com53-repositories0x637d5e.RepositoryImportController
...
func (inst * comFactory4pComRepositoryImportController) getterForFieldRepoStateLoaderSelector (context application.InstanceContext) service0x3e063d.LocalRepositoryStateLoader {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com53-repositories0x637d5e.RepositoryImportController")
...
// comFactory4pComRemoteRepositoryController : the factory of component: com56-repositories0x637d5e.RemoteRepositoryController
...
func (inst * comFactory4pComRemoteRepositoryController) getterForFieldRepoServiceSelector (context application.InstanceContext) service0x3e063d.RemoteRepositoryService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com56-repositories0x637d5e.RemoteRepositoryController")
		eb.Set("field", "RepoService")
		eb.Set("type1", "?")
...
// comFactory4pComImpOptionService : the factory of component: OptionService
type comFactory4pComImpOptionService struct {

    mPrototype * options0x10c3ff.ImpOptionService
...
func (inst * comFactory4pComImpOptionService) init() application.ComponentFactory {
...
func (inst * comFactory4pComImpOptionService) newObject() * options0x10c3ff.ImpOptionService {
	return & options0x10c3ff.ImpOptionService {}
}

func (inst * comFactory4pComImpOptionService) castObject(instance application.ComponentInstance) * options0x10c3ff.ImpOptionService {
	return instance.Get().(*options0x10c3ff.ImpOptionService)
}

func (inst * comFactory4pComImpOptionService) GetPrototype() lang.Object {
	return inst.mPrototype
}

func (inst * comFactory4pComImpOptionService) NewInstance() application.ComponentInstance {
	return config.SimpleInstance(inst, inst.newObject())
}

func (inst * comFactory4pComImpOptionService) AfterService() application.ComponentAfterService {
	return inst
}

func (inst * comFactory4pComImpOptionService) Init(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComImpOptionService) Destroy(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComImpOptionService) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
...
//getterForFieldACSelector
func (inst * comFactory4pComImpOptionService) getterForFieldACSelector (context application.InstanceContext) application.Context {
    return context.Context()
}
...
// comFactory4pComTheOptionController : the factory of component: com60-options0x10c3ff.TheOptionController
type comFactory4pComTheOptionController struct {

    mPrototype * options0x10c3ff.TheOptionController
...
func (inst * comFactory4pComTheOptionController) init() application.ComponentFactory {
...
func (inst * comFactory4pComTheOptionController) newObject() * options0x10c3ff.TheOptionController {
	return & options0x10c3ff.TheOptionController {}
}

func (inst * comFactory4pComTheOptionController) castObject(instance application.ComponentInstance) * options0x10c3ff.TheOptionController {
	return instance.Get().(*options0x10c3ff.TheOptionController)
}

func (inst * comFactory4pComTheOptionController) GetPrototype() lang.Object {
	return inst.mPrototype
}

func (inst * comFactory4pComTheOptionController) NewInstance() application.ComponentInstance {
	return config.SimpleInstance(inst, inst.newObject())
}

func (inst * comFactory4pComTheOptionController) AfterService() application.ComponentAfterService {
	return inst
}

func (inst * comFactory4pComTheOptionController) Init(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComTheOptionController) Destroy(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComTheOptionController) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
...
//getterForFieldResponderSelector
func (inst * comFactory4pComTheOptionController) getterForFieldResponderSelector (context application.InstanceContext) glass0x47343f.MainResponder {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com60-options0x10c3ff.TheOptionController")
		eb.Set("field", "Responder")
		eb.Set("type1", "?")
		eb.Set("type2", "glass0x47343f.MainResponder")
		context.HandleError(eb.Create())
...
//getterForFieldOptionServiceSelector
func (inst * comFactory4pComTheOptionController) getterForFieldOptionServiceSelector (context application.InstanceContext) service0x3e063d.OptionService {
...
// comFactory4pComTheTrashController : the factory of component: com61-trash0xd00f34.TheTrashController
type comFactory4pComTheTrashController struct {

    mPrototype * trash0xd00f34.TheTrashController

	
	mTrashSerSelector config.InjectionSelector
	mTrashDaoSelector config.InjectionSelector
	mResponderSelector config.InjectionSelector

}

func (inst * comFactory4pComTheTrashController) init() application.ComponentFactory {

	
	inst.mTrashSerSelector = config.NewInjectionSelector("#TrashService",nil)
...
func (inst * comFactory4pComTheTrashController) newObject() * trash0xd00f34.TheTrashController {
	return & trash0xd00f34.TheTrashController {}
}

func (inst * comFactory4pComTheTrashController) castObject(instance application.ComponentInstance) * trash0xd00f34.TheTrashController {
	return instance.Get().(*trash0xd00f34.TheTrashController)
}

func (inst * comFactory4pComTheTrashController) GetPrototype() lang.Object {
	return inst.mPrototype
}

func (inst * comFactory4pComTheTrashController) NewInstance() application.ComponentInstance {
	return config.SimpleInstance(inst, inst.newObject())
}

func (inst * comFactory4pComTheTrashController) AfterService() application.ComponentAfterService {
	return inst
}

func (inst * comFactory4pComTheTrashController) Init(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComTheTrashController) Destroy(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComTheTrashController) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
	
	obj := inst.castObject(instance)
	obj.TrashSer = inst.getterForFieldTrashSerSelector(context)
	obj.TrashDao = inst.getterForFieldTrashDaoSelector(context)
	obj.Responder = inst.getterForFieldResponderSelector(context)
	return context.LastError()
}

//getterForFieldTrashSerSelector
func (inst * comFactory4pComTheTrashController) getterForFieldTrashSerSelector (context application.InstanceContext) service0x3e063d.TrashService {

	o1 := inst.mTrashSerSelector.GetOne(context)
	o2, ok := o1.(service0x3e063d.TrashService)
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com61-trash0xd00f34.TheTrashController")
		eb.Set("field", "TrashSer")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.TrashService")
		context.HandleError(eb.Create())
		return nil
...
//getterForFieldTrashDaoSelector
func (inst * comFactory4pComTheTrashController) getterForFieldTrashDaoSelector (context application.InstanceContext) dao0x5af8d0.TrashDAO {

	o1 := inst.mTrashDaoSelector.GetOne(context)
	o2, ok := o1.(dao0x5af8d0.TrashDAO)
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com61-trash0xd00f34.TheTrashController")
		eb.Set("field", "TrashDao")
		eb.Set("type1", "?")
		eb.Set("type2", "dao0x5af8d0.TrashDAO")
		context.HandleError(eb.Create())
		return nil
	}
	return o2
...
//getterForFieldResponderSelector
func (inst * comFactory4pComTheTrashController) getterForFieldResponderSelector (context application.InstanceContext) glass0x47343f.MainResponder {
...
// comFactory4pComImpTrashService : the factory of component: TrashService
type comFactory4pComImpTrashService struct {

    mPrototype * trash0xd00f34.ImpTrashService
...
func (inst * comFactory4pComImpTrashService) init() application.ComponentFactory {
...
func (inst * comFactory4pComImpTrashService) newObject() * trash0xd00f34.ImpTrashService {
	return & trash0xd00f34.ImpTrashService {}
}

func (inst * comFactory4pComImpTrashService) castObject(instance application.ComponentInstance) * trash0xd00f34.ImpTrashService {
	return instance.Get().(*trash0xd00f34.ImpTrashService)
}

func (inst * comFactory4pComImpTrashService) GetPrototype() lang.Object {
	return inst.mPrototype
}

func (inst * comFactory4pComImpTrashService) NewInstance() application.ComponentInstance {
	return config.SimpleInstance(inst, inst.newObject())
}

func (inst * comFactory4pComImpTrashService) AfterService() application.ComponentAfterService {
	return inst
}
...
func (inst * comFactory4pComImpTrashService) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
...
//getterForFieldTrashDaoSelector
func (inst * comFactory4pComImpTrashService) getterForFieldTrashDaoSelector (context application.InstanceContext) dao0x5af8d0.TrashDAO {
...
// comFactory4pComImpTrashDao : the factory of component: TrashDAO
type comFactory4pComImpTrashDao struct {

    mPrototype * trash0xd00f34.ImpTrashDao
...
func (inst * comFactory4pComImpTrashDao) init() application.ComponentFactory {
...
func (inst * comFactory4pComImpTrashDao) newObject() * trash0xd00f34.ImpTrashDao {
	return & trash0xd00f34.ImpTrashDao {}
}

func (inst * comFactory4pComImpTrashDao) castObject(instance application.ComponentInstance) * trash0xd00f34.ImpTrashDao {
	return instance.Get().(*trash0xd00f34.ImpTrashDao)
}

func (inst * comFactory4pComImpTrashDao) GetPrototype() lang.Object {
	return inst.mPrototype
}

func (inst * comFactory4pComImpTrashDao) NewInstance() application.ComponentInstance {
	return config.SimpleInstance(inst, inst.newObject())
}

func (inst * comFactory4pComImpTrashDao) AfterService() application.ComponentAfterService {
	return inst
}

func (inst * comFactory4pComImpTrashDao) Init(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComImpTrashDao) Destroy(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComImpTrashDao) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
...
//getterForFieldAgentSelector
func (inst * comFactory4pComImpTrashDao) getterForFieldAgentSelector (context application.InstanceContext) dbagent0x9f90fb.GormDBAgent {
...
// comFactory4pComWpmSetupController : the factory of component: com65-setup0xd9ff02.WpmSetupController
...
func (inst * comFactory4pComWpmSetupController) getterForFieldResponderSelector (context application.InstanceContext) glass0x47343f.MainResponder {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com65-setup0xd9ff02.WpmSetupController")
		eb.Set("field", "Responder")
		eb.Set("type1", "?")
		eb.Set("type2", "glass0x47343f.MainResponder")
		context.HandleError(eb.Create())
...
// comFactory4pComNamespaceController : the factory of component: com68-namespaces0xceefcf.NamespaceController
...
func (inst * comFactory4pComNamespaceController) getterForFieldNamespaceServiceSelector (context application.InstanceContext) service0x3e063d.NamespaceService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com68-namespaces0xceefcf.NamespaceController")
		eb.Set("field", "NamespaceService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.NamespaceService")
		context.HandleError(eb.Create())
...
// comFactory4pComTheStatisticController : the factory of component: com71-statistics0x0575cd.TheStatisticController
type comFactory4pComTheStatisticController struct {

    mPrototype * statistics0x0575cd.TheStatisticController

	
	mResponderSelector config.InjectionSelector
	mStatisticDAOSelector config.InjectionSelector

}

func (inst * comFactory4pComTheStatisticController) init() application.ComponentFactory {

	
	inst.mResponderSelector = config.NewInjectionSelector("#glass-main-responder",nil)
	inst.mStatisticDAOSelector = config.NewInjectionSelector("#StatisticDAO",nil)
...
func (inst * comFactory4pComTheStatisticController) newObject() * statistics0x0575cd.TheStatisticController {
	return & statistics0x0575cd.TheStatisticController {}
}

func (inst * comFactory4pComTheStatisticController) castObject(instance application.ComponentInstance) * statistics0x0575cd.TheStatisticController {
	return instance.Get().(*statistics0x0575cd.TheStatisticController)
}

func (inst * comFactory4pComTheStatisticController) GetPrototype() lang.Object {
	return inst.mPrototype
}

func (inst * comFactory4pComTheStatisticController) NewInstance() application.ComponentInstance {
	return config.SimpleInstance(inst, inst.newObject())
}

func (inst * comFactory4pComTheStatisticController) AfterService() application.ComponentAfterService {
	return inst
}

func (inst * comFactory4pComTheStatisticController) Init(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComTheStatisticController) Destroy(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComTheStatisticController) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
	
	obj := inst.castObject(instance)
	obj.Responder = inst.getterForFieldResponderSelector(context)
	obj.StatisticDAO = inst.getterForFieldStatisticDAOSelector(context)
	return context.LastError()
}

//getterForFieldResponderSelector
func (inst * comFactory4pComTheStatisticController) getterForFieldResponderSelector (context application.InstanceContext) glass0x47343f.MainResponder {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com71-statistics0x0575cd.TheStatisticController")
		eb.Set("field", "Responder")
		eb.Set("type1", "?")
		eb.Set("type2", "glass0x47343f.MainResponder")
		context.HandleError(eb.Create())
...
//getterForFieldStatisticDAOSelector
func (inst * comFactory4pComTheStatisticController) getterForFieldStatisticDAOSelector (context application.InstanceContext) dao0x5af8d0.StatisticDAO {

	o1 := inst.mStatisticDAOSelector.GetOne(context)
	o2, ok := o1.(dao0x5af8d0.StatisticDAO)
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com71-statistics0x0575cd.TheStatisticController")
		eb.Set("field", "StatisticDAO")
		eb.Set("type1", "?")
		eb.Set("type2", "dao0x5af8d0.StatisticDAO")
		context.HandleError(eb.Create())
		return nil
	}
	return o2
...
// comFactory4pComImpStatisticDao : the factory of component: StatisticDAO
type comFactory4pComImpStatisticDao struct {

    mPrototype * statistics0x0575cd.ImpStatisticDao
...
func (inst * comFactory4pComImpStatisticDao) init() application.ComponentFactory {
...
func (inst * comFactory4pComImpStatisticDao) newObject() * statistics0x0575cd.ImpStatisticDao {
	return & statistics0x0575cd.ImpStatisticDao {}
}

func (inst * comFactory4pComImpStatisticDao) castObject(instance application.ComponentInstance) * statistics0x0575cd.ImpStatisticDao {
	return instance.Get().(*statistics0x0575cd.ImpStatisticDao)
}

func (inst * comFactory4pComImpStatisticDao) GetPrototype() lang.Object {
	return inst.mPrototype
}

func (inst * comFactory4pComImpStatisticDao) NewInstance() application.ComponentInstance {
	return config.SimpleInstance(inst, inst.newObject())
}

func (inst * comFactory4pComImpStatisticDao) AfterService() application.ComponentAfterService {
	return inst
}

func (inst * comFactory4pComImpStatisticDao) Init(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComImpStatisticDao) Destroy(instance application.ComponentInstance) error {
	return nil
}

func (inst * comFactory4pComImpStatisticDao) Inject(instance application.ComponentInstance, context application.InstanceContext) error {
...
//getterForFieldAgentSelector
func (inst * comFactory4pComImpStatisticDao) getterForFieldAgentSelector (context application.InstanceContext) dbagent0x9f90fb.GormDBAgent {
...
//getterForFieldFSSelector
func (inst * comFactory4pComAppDataServiceImpl) getterForFieldFSSelector (context application.InstanceContext) service0x3e063d.FileSystemService {
...
// comFactory4pComWpmDataSource : the factory of component: com80-support0xf47d7f.WpmDataSource
...
func (inst * comFactory4pComWpmDataSource) getterForFieldDMSelector (context application.InstanceContext) datasource0x68a737.DriverManager {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com80-support0xf47d7f.WpmDataSource")
		eb.Set("field", "DM")
		eb.Set("type1", "?")
...
// comFactory4pComWindowsPlatformServiceImpl : the factory of component: com81-platforms0xb539c0.WindowsPlatformServiceImpl
...
// comFactory4pComLinuxPlatformServiceImpl : the factory of component: com84-platforms0xb539c0.LinuxPlatformServiceImpl
...
// comFactory4pComExecutableController : the factory of component: com86-executables0xd3773a.ExecutableController
...
func (inst * comFactory4pComExecutableController) getterForFieldExecutableServiceSelector (context application.InstanceContext) service0x3e063d.ExecutableService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com86-executables0xd3773a.ExecutableController")
		eb.Set("field", "ExecutableService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.ExecutableService")
		context.HandleError(eb.Create())
...
// comFactory4pComExecutableImportController : the factory of component: com88-executables0xd3773a.ExecutableImportController
...
func (inst * comFactory4pComExecutableImportController) getterForFieldExecutableImportServiceSelector (context application.InstanceContext) service0x3e063d.ExecutableImportService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com88-executables0xd3773a.ExecutableImportController")
		eb.Set("field", "ExecutableImportService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.ExecutableImportService")
		context.HandleError(eb.Create())
...
// comFactory4pComFileSystemHandler : the factory of component: com91-handlers0x162741.FileSystemHandler
...
//getterForFieldFSSelector
func (inst * comFactory4pComFileSystemHandler) getterForFieldFSSelector (context application.InstanceContext) service0x3e063d.FileSystemService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com91-handlers0x162741.FileSystemHandler")
		eb.Set("field", "FS")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.FileSystemService")
		context.HandleError(eb.Create())
...
// comFactory4pComFindTemplateFilter : the factory of component: com92-v3filters0xa6552a.FindTemplateFilter
...
func (inst * comFactory4pComFindTemplateFilter) getterForFieldIntentTemplateServiceSelector (context application.InstanceContext) service0x3e063d.IntentTemplateService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com92-v3filters0xa6552a.FindTemplateFilter")
		eb.Set("field", "IntentTemplateService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.IntentTemplateService")
		context.HandleError(eb.Create())
...
// comFactory4pComCLIRunnerFilter : the factory of component: com93-v3filters0xa6552a.CLIRunnerFilter
...
func (inst * comFactory4pComCLIRunnerFilter) getterForFieldIntentHandlerServiceSelector (context application.InstanceContext) service0x3e063d.IntentHandlerService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com93-v3filters0xa6552a.CLIRunnerFilter")
		eb.Set("field", "IntentHandlerService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.IntentHandlerService")
		context.HandleError(eb.Create())
...
// comFactory4pComCheckTemplateFilter : the factory of component: com94-v3filters0xa6552a.CheckTemplateFilter
...
// comFactory4pComPrepareActionFilter : the factory of component: com95-v3filters0xa6552a.PrepareActionFilter
...
func (inst * comFactory4pComPrepareActionFilter) getterForFieldProfileServiceSelector (context application.InstanceContext) service0x3e063d.ProfileService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com95-v3filters0xa6552a.PrepareActionFilter")
		eb.Set("field", "ProfileService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.ProfileService")
		context.HandleError(eb.Create())
...
// comFactory4pComCLIMakerFilter : the factory of component: com96-v3filters0xa6552a.CLIMakerFilter
...
//getterForFieldFileSystemServiceSelector
func (inst * comFactory4pComCLIMakerFilter) getterForFieldFileSystemServiceSelector (context application.InstanceContext) service0x3e063d.FileSystemService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com96-v3filters0xa6552a.CLIMakerFilter")
		eb.Set("field", "FileSystemService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.FileSystemService")
		context.HandleError(eb.Create())
...
// comFactory4pComPreparePropertiesFilter : the factory of component: com97-v3filters0xa6552a.PreparePropertiesFilter
...
// comFactory4pComExampleFilter : the factory of component: com98-v3filters0xa6552a.ExampleFilter
...
// comFactory4pComHostFilter : the factory of component: com99-filter0x8aa8f6.HostFilter
...
// comFactory4pComHTTP404Filter : the factory of component: com100-filter0x8aa8f6.HTTP404Filter
...
// comFactory4pComOnlineDocumentExampleController : the factory of component: com101-controller0x9dc399.OnlineDocumentExampleController
...
func (inst * comFactory4pComOnlineDocumentExampleController) getterForFieldResponderSelector (context application.InstanceContext) glass0x47343f.MainResponder {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com101-controller0x9dc399.OnlineDocumentExampleController")
		eb.Set("field", "Responder")
		eb.Set("type1", "?")
		eb.Set("type2", "glass0x47343f.MainResponder")
		context.HandleError(eb.Create())
...
// comFactory4pComAuthController : the factory of component: com102-controller0x9dc399.AuthController
...
func (inst * comFactory4pComAuthController) getterForFieldResponderSelector (context application.InstanceContext) glass0x47343f.MainResponder {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com102-controller0x9dc399.AuthController")
		eb.Set("field", "Responder")
		eb.Set("type1", "?")
		eb.Set("type2", "glass0x47343f.MainResponder")
		context.HandleError(eb.Create())
...
// comFactory4pComExampleController : the factory of component: com103-controller0x9dc399.ExampleController
...
func (inst * comFactory4pComExampleController) getterForFieldResponderSelector (context application.InstanceContext) glass0x47343f.MainResponder {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com103-controller0x9dc399.ExampleController")
		eb.Set("field", "Responder")
		eb.Set("type1", "?")
		eb.Set("type2", "glass0x47343f.MainResponder")
		context.HandleError(eb.Create())
...
// comFactory4pComUploadController : the factory of component: com104-controller0x9dc399.UploadController
...
func (inst * comFactory4pComUploadController) getterForFieldFileSystemServiceSelector (context application.InstanceContext) service0x3e063d.FileSystemService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com104-controller0x9dc399.UploadController")
		eb.Set("field", "FileSystemService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.FileSystemService")
		context.HandleError(eb.Create())
...
// comFactory4pComPlatformController : the factory of component: com105-controller0x9dc399.PlatformController
...
func (inst * comFactory4pComPlatformController) getterForFieldPlatformServiceSelector (context application.InstanceContext) service0x3e063d.PlatformService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com105-controller0x9dc399.PlatformController")
		eb.Set("field", "PlatformService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.PlatformService")
		context.HandleError(eb.Create())
...
// comFactory4pComAboutController : the factory of component: com106-controller0x9dc399.AboutController
...
func (inst * comFactory4pComAboutController) getterForFieldAboutServiceSelector (context application.InstanceContext) service0x3e063d.AboutService {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com106-controller0x9dc399.AboutController")
		eb.Set("field", "AboutService")
		eb.Set("type1", "?")
		eb.Set("type2", "service0x3e063d.AboutService")
		context.HandleError(eb.Create())
